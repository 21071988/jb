...
<div class="reg__wrapper">
    <div class="reg__windows">
    <div class="toy">
      <?php require($_SERVER["DOCUMENT_ROOT"]."/svgfiles/giraffe.php");?>
    </div>
      <div class="reg__window">
        <div class="reg__window__menu">
          <a class="form__type reg__trigger">вход</a>
          <hr>
          <a class="form__type reg__trigger active">Регистрация</a>
        </div>
        <div class="reg__window__form">
          ...
          <form action="" id="reg__form" class='reg__form order__wrapper' method="post">
            ...
            <input type="password" name='reg__pswrd' id='psw__validation'>
            <?php require($_SERVER["DOCUMENT_ROOT"]."/svgfiles/longline.php");?>
